...
Consequently, we must consider (B): \textit{Under what circumstances can we trust these large models?} % with, of
...
\begin{enumerate}
    ...
    % For instance, how the rich framework of causal inference can be used to make sense of the impressive capabilities of large models. 
